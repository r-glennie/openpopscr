...
```
```{r fitmoddetage, results = "hide", cache = TRUE}
...
```{r fittrans, results = "hide", cache = TRUE}
# fit model 
trans$fit()
```
```{r analysetrans}
