...
extern SEXP _openpopscr_C_calc_movebeta(SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP);
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_openpopscr_C_calc_movebeta",      (DL_FUNC) &_openpopscr_C_calc_movebeta,    14},
    {NULL, NULL, 0}
};
