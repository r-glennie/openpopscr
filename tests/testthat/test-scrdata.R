...
test_that("ScrData checks covariates", {
  ...
  expect_error(dat$add_covariate("cov5", matrix(0, nr = 3, nc = 3), "j"), "Invalid covariate.")
  ...
  expect_error(dat$add_covariate("cov8", 1:45, "kj"), "Invalid covariate.")
  expect_error(dat$add_covariate("cov9", matrix(0, nr = 9, nc = 5), "kj"), "Invalid covariate.")
  expect_error(dat$add_covariate("cov10", 1:45, "km"), "Invalid covariate.")
...
test_that("ScrData loads covariates", {
  ...
  expect_equal(names(dat$covs()), c("t", "primary", "x", "y", "detcov", "timecov", "dettime", "timemesh", "mesh"))
